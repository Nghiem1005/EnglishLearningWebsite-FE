...
const DeleteLesson = ({ isShowModal, setIsShowModal }) => {
  ...
  const loginWithGoogle = async () => {
    ref.current.href = "http://localhost:8080/login/google?view=LESSON&redirectView=http://localhost:8080/calendar";
    ref.current.click();
  };
        ...
        <div className="modal-content py-6 text-left px-6">
          <div className="flex justify-between items-center pb-3">
            <div>
              ...
              <p className="text-sm">
                Vì lesson liên quan đến xác thực email nên bạn cần phải đăng
                nhập.
              </p>
            </div>
            <div
